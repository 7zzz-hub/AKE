...
class MiniGPT4(Blip2Base):
    ...
    def __init__(
        ...
        qformer_checkpoint="huggingface_cache/blip2_pretrained_flant5xxl.pth",
        img_size=224,
        drop_path_rate=0,
    ...
    def forward(self, samples):
        if samples['image'] is not None:
            ...
            to_regress_embeds = self.llama_model.model.embed_tokens(to_regress_tokens.input_ids.cpu())
