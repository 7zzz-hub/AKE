...
class MultimodalEditor:
    ...
    def __init__(self,
        ...
        if hparams.model_class in ["Blip2OPT", "minigpt4"]:
            ...
            self.vis_processor = CLIPImageProcessor.from_pretrained(hparams.name, trust_remote_code=True)
        else:
        ...
        if type(self.model_name) is str:
            if hparams.model_name == "blip2":
                ...
                model = Blip2OPT(
                    ...
                    vit_precision="fp32",
                    freeze_vit=True,
                    opt_model=hparams.tokenizer_name,
            ...
            if hparams.model_name in  ["blip2", "minigpt4"]:
                ...
                vis_processor = transformers.CLIPImageProcessor.from_pretrained("huggingface_cache/clip-vit-large-patch14-336")
                self.vis_tok = lambda image: vis_processor(image, return_tensors='pt')['pixel_values'].to(dtype=torch.float32)
            elif hparams.model_class ==  "qwen-vl":
        ...
        for i, request in enumerate(requests):
            ...
            if self.alg_name == 'IKE':
                ...
                metrics = {
                    ...
                    "time": exec_time,
                    "post": compute_icl_multimodal_edit_quality(self.model, self.vis_processor, self.model_name, self.hparams, self.tok, icl_examples,
                                                     request, self.hparams.device),
                    "pre": compute_icl_multimodal_edit_quality(self.model, self.vis_processor, self.model_name, self.hparams, self.tok, [''],
