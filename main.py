...
def parse_args():
    ...
    parser.add_argument('--sample_limit', type=int, default=config.get('sample_limit'), help='Maximum edit samples to evaluate')
    ...
    parser.add_argument('--direction_samples', type=int, default=config.get('direction_samples'), help='Limit images used to estimate ZM_K')
    parser.add_argument('--zm_k_path', type=str, default=config.get('zm_k_path'), help='Optional explicit ZM_K cache path')
    parser.add_argument('--image_size', type=int, default=config.get('image_size'))
    parser.add_argument('--patch_num', type=int, default=config.get('patch_num'))
    ...
    parser.add_argument('--token_locality_loss_weight', type=float,
                        default=config.get('token_locality_loss_weight', 0.0),
                        help='Weight of pre-edit next-token KL locality loss')
    ...
    parser.add_argument('--nsteps', type=int, default=config.get('nsteps', 100),
                        help='Number of optimization steps per edit')
